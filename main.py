...
class WindowSimulator:
    ...
    def widget_creator(self):
                ...
                self.loading_button =tk.Button(button_row_frame ,text="Load File",
                    font=("Arial" ,15),bg="#E07B1f",fg=self.secondary,
                ...
                self.resetting_button =tk.Button(button_row_frame ,text="Reset",
                    ...
                    font=("Arial",15),bg ="#555555",fg="white",
                ...
                self.code_box.insert("end", "010007\n010008\n020007\n030008\n021009\n011009\n043000\n000000\n000000\n000000\n-999999")
                tk.Label(right_panel_frame ,text="One instruction per line. End with -999999.",
    ...
    def sim_starter(self):
        ...
        lines = program_editor_text_pull.splitlines()
        if len(lines) > 250:
            self.box_print("Error: Program exceeds 250 lines.\n", "error")
            return
        ...
        self.uv_sim_instance =UVSimulator(memory_size=250)
    ...
    def input_sender(self ,event=None):
        ...
        try:
            ...
            if user_int < -999999 or user_int > 999999:
                    self.box_print("Need a 6 digit integer.\n" ,"error")
                    return
        except ValueError:
